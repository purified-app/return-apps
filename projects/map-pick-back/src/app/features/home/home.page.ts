...
@Component({
  ...
  template: `
    <rb-home-docs
      ...
      lead="Leaflet map pin picker. After Done, the point is returned as value (lat,lng) with zoom."
      ctaLabel="Open map"
...
export class HomePage {
  readonly openExample =
    '?returnUrl=<urlencoded-https-url>&state=<optional>&allowedOrigins=<optional>&lat=&lng=&zoom=';
